...
工作目录结构见 [Phase 2：构思核心框架](../workflow.md#phase-2构思核心框架)。设定.md 内容构成：核心框架 + 人设 + 反转铺垫 + 贯穿道具（含三次出现追踪表）+ 反派设计 + 对标摘要。小节大纲.md 每节 1 行，格式以 [设计任务（框架确定后执行）](../workflow.md#设计任务框架确定后执行) 第 4 步为准。
